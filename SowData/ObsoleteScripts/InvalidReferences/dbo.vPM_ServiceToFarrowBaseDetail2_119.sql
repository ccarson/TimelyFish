CREATE VIEW [dbo].[vPM_ServiceToFarrowBaseDetail2_119] (FarmID, WeekOfDate, SowID, SowGenetics, SowParity)
	As
...
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[vPM_ServiceToFarrowBaseDetail2_119] TO [se\analysts]
    AS [dbo];
