CREATE VIEW [dbo].[vPM_EndingFemaleInventoryBase2] (FarmID, SowID, WeekOfDate, SowGenetics, SowParity)
	AS
...
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[vPM_EndingFemaleInventoryBase2] TO [se\analysts]
    AS [dbo];
