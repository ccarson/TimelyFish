...
--	Parms:
--*************************************************************
CREATE VIEW dbo.vLevel3LitterUnknown_ALL
AS
Select Distinct m.FarmID, m.SowID, m.EventDate,
GeneticAlias as Dam_Line,s.EntryDate,
...
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[vLevel3LitterUnknown_ALL] TO [se\analysts]
    AS [dbo];
