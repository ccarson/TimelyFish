create procedure [dbo].[cfp_BuildEssbasePigsBornforFarrowedAndWeaned_WO_remove]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_BuildEssbasePigsBornforFarrowedAndWeaned_WO_remove] TO [db_sp_exec]
    AS [dbo];
