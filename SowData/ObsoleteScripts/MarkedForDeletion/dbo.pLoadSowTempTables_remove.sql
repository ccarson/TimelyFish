CREATE PROCEDURE [pLoadSowTempTables_remove]
	@FarmID varchar(8)
	
	AS
	DECLARE @FirstDate smalldatetime
	SELECT @FirstDate =  min(weekofdate) -365 from WeekDefinitionTemp
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[pLoadSowTempTables_remove] TO [se\analysts]
    AS [dbo];
