...
/****** Object:  Stored Procedure dbo.pBuildEssbaseUploadTempSue    Script Date: 10/10/2005 2:29:07 PM ******/

/****** Object:  Stored Procedure dbo.pBuildEssbaseUploadTemp2    Script Date: 10/10/2005 2:08:30 PM ******/
------------------------------------------------------------------------
-- New procedure for building Essbase temp table - wanted to keep the --
-- old one for now
------------------------------------------------------------------------
CREATE   PROC [pBuildEssbaseUploadTempSue_remove]
	@FarmID varchar(8)
	AS
...
/*	BEGIN TRANSACTION
	...
	BEGIN TRANSACTION  
	INSERT INTO dbo.EssbaseUploadFeed (FarmID, WeekOfDate, PICWeek, PICYear, FiscalPeriod, FiscalYear, Account, Qty)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[pBuildEssbaseUploadTempSue_remove] TO [se\analysts]
    AS [dbo];
