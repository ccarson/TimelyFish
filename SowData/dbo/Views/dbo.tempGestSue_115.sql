CREATE View [tempGestSue_115] AS
...
FROM DayDefinitionTemp dd
CROSS JOIN SowGroupEventTemp se WITH (NOLOCK) -- ESSENTIALLY LATEST GROUP EVENT BEFORE REQUESTED DATE
...
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[tempGestSue_115] TO [se\analysts]
    AS [dbo];
