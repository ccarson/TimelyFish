CREATE TABLE [dbo].[SowNurseEventTemp] (
    ...
    [SortCode]    INT           NULL,
    CONSTRAINT [PK_SowNurseEventTemp] PRIMARY KEY CLUSTERED ([EventID] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [idxNurseEventFarm]
    ON [dbo].[SowNurseEventTemp]([FarmID] ASC, [EventType] ASC) WITH (FILLFACTOR = 90);
