CREATE TABLE [dbo].[ExpMasterBreedingDetail] (
...
GO
create trigger dbo.trIns_ExpMasterBreedingDetail ON dbo.ExpMasterBreedingDetail
	FOR INSERT 
	As
	-- INSERT ONLY THE NEW ROWS - 
	INSERT INTO dbo.PCUploadMasterBreed (Form_Id,FormSerialID,CSID,Verify_Wks,RowNbr,FarmID,SowID,AlternateID,
		EventDay,EventWeek,Service1Date,Service1SemenID,Service1BreederID,Service1AMPMFlag,Service1TransferStatus,
		Service2Date,Service2SemenID,Service2BreederID,Service2AMPMFlag,Service2TransferStatus,
		Service3Date,Service3SemenID,Service3BreederID,Service3AMPMFlag,Service3TransferStatus,
		DateInserted)
	SELECT i.Form_Id, i.FormSerialID, i.CSID, i.Verify_Wks, i.RowNbr, i.FarmID, i.SowID, i.AlternateID, 
	i.CurrentDate, i.WeekNbr, i.CurrentDate, i.Service1SemenID, i.Service1BreederID, i.Service1AMPMFlag,0,
	i.Service2Date,i.Service2SemenID,i.Service2BreederID,i.Service2AMPMFlag,0,
	i.Service3Date,i.Service3SemenID,i.Service3BreederID,i.Service3AMPMFlag,0,GetDate()
	FROM INSERTED i
	LEFT JOIN dbo.PCUploadMasterBreed d ON i.Form_Id = d.Form_Id 
	...
	UPDATE p
	SET p.Service2Date = i.Service2Date, p.Service2SemenID = i.Service2SemenID, p.Service2BreederID = i.Service2BreederID, p.Service2AMPMFlag = i.Service2AMPMFlag
	FROM dbo.PCUploadMasterBreed p
	...
	UPDATE p
	SET p.Service3Date = i.Service3Date, p.Service3SemenID = i.Service3SemenID, p.Service3BreederID = i.Service3BreederID, p.Service3AMPMFlag = i.Service3AMPMFlag
	FROM dbo.PCUploadMasterBreed p
	JOIN Inserted i ON i.Form_Id = p.Form_Id 
		AND i.FarmID = p.FarmID
		AND i.FormSerialID = p.FormSerialID 
