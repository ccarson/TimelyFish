...
-- Description:	Selects PartialTicket records by feed mill
-- ===================================================================
CREATE PROCEDURE dbo.cfp_CORN_PURCHASING_PARTIAL_TICKET_SELECT_BY_FEED_MILL
(
  @FeedMillID	char(10)
)
AS
...
WHERE CT.FeedMillID = @FeedMillID AND PT.SentToAccountsPayable <> 1

END

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_PARTIAL_TICKET_SELECT_BY_FEED_MILL] TO [db_sp_exec]
    AS [dbo];
