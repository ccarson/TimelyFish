...
-- ==================================================
CREATE PROCEDURE [dbo].[cfp_PACKER_CONTRACT_SELECT]
(
...
BEGIN
	...
	and (@EffectiveDate between packerContract.ContractFromDate and packerContract.ContractToDate)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_PACKER_CONTRACT_SELECT] TO [db_sp_exec]
    AS [dbo];
