...
--		based on date criteria, that have been changed
-- =============================================

CREATE PROC [dbo].[cfp_SITES_FROM_TRANSPORTATION_SCHEDULE_SELECT_CHANGES]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_SITES_FROM_TRANSPORTATION_SCHEDULE_SELECT_CHANGES] TO [db_sp_exec]
    AS [dbo];
