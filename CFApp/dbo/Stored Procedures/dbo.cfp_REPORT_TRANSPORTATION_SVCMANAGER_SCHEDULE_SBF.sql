...
-- =============================================
CREATE PROCEDURE
    [dbo].[cfp_REPORT_TRANSPORTATION_SVCMANAGER_SCHEDULE_SBF] (
        @ContactID      int
...
WHERE
    cftPM.MovementDate BETWEEN @StartDate AND @EndDate
        AND ISNULL( NULLIF( @PMTypeString, '00' ), cftPM.PMTypeID ) = cftPM.PMTypeID
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_TRANSPORTATION_SVCMANAGER_SCHEDULE_SBF] TO [db_sp_exec]
    AS [dbo];
