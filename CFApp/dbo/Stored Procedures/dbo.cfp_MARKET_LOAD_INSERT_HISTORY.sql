...
-- Description:	Inserts a record in the cft_PM_HISTORY table
-- Used by the Market Movmenet Schedule screen
-- =============================================
CREATE PROCEDURE [dbo].[cfp_MARKET_LOAD_INSERT_HISTORY]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_MARKET_LOAD_INSERT_HISTORY] TO [db_sp_exec]
    AS [dbo];
