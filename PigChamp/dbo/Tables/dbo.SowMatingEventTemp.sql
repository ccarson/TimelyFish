CREATE TABLE [dbo].[SowMatingEventTemp] (
    ...
    CONSTRAINT [PK_SowMatingEventTempID] PRIMARY KEY CLUSTERED ([EventID] ASC) WITH (FILLFACTOR = 80)
);


GO
CREATE NONCLUSTERED INDEX [idxSowMatingEventFarm]
    ON [dbo].[SowMatingEventTemp]([FarmID] ASC, [MatingType] ASC) WITH (FILLFACTOR = 80);
