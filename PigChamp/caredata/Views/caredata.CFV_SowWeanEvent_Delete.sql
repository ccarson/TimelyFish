...
CREATE VIEW [caredata].[CFV_SowWeanEvent_Delete]
AS
  ...
  inner join caredata.bh_events ev (NOLOCK) on IH.identity_id = ev.identity_id and ev.[event_type] in (220,265) and ev.[deletion_date] is Not NULL
