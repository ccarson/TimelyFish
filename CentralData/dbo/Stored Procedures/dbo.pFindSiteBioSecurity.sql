...
Create Procedure dbo.pFindSiteBioSecurity
	@EffectiveDate smalldatetime,
	@ContactID int
AS
Select dcontact.ContactID, dlevel.LevelPrecedence,
	dphase.PhasePrecedence, dtype.TypePrecedence,dsystem.SystemPrecedence
FROM 
