CREATE TABLE [dbo].[APTran] (
    ...
    [LCCode]          CHAR (10)     CONSTRAINT [DF__APTran__LCCode__1A14E395] DEFAULT (' ') NOT NULL,
    [LineId]          INT           NOT NULL,
    ...
    CONSTRAINT [APTran0] PRIMARY KEY CLUSTERED ([BatNbr] ASC, [Acct] ASC, [Sub] ASC, [RefNbr] ASC, [RecordID] ASC) WITH (FILLFACTOR = 90)
);
