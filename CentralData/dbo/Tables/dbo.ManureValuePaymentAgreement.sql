CREATE TABLE [dbo].[ManureValuePaymentAgreement] (
    ...
    CONSTRAINT [PK_ManureValuePaymentAgreement] PRIMARY KEY CLUSTERED ([ManureValueAgreementID] ASC, [PaymentTypeID] ASC) WITH (FILLFACTOR = 90)
);
