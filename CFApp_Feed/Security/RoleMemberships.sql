...
GO
ALTER ROLE [db_datareader] ADD MEMBER [SE\sqlsvcsaturn];
...
GO
ALTER ROLE [db_datareader] ADD MEMBER [SE\Earth~CFApp_Feed~DataReader];
...
GO
ALTER ROLE [db_datawriter] ADD MEMBER [SE\sqlsvcsaturn];
