CREATE TABLE [dbo].[cft_SowMart_weekly_rollup_stg] (
...
GO
CREATE UNIQUE CLUSTERED INDEX [idx_PK_cft_sowmart_weekly_rollup_bkup]
    ON [dbo].[cft_SowMart_weekly_rollup_stg]([PicYear_week] ASC, [FarmID] ASC, [SiteID] ASC, [reportinggroupid] ASC) WITH (FILLFACTOR = 100);
