CREATE TABLE [dbo].[cft_SowMart_Detail_data_stg] (
...
CREATE UNIQUE CLUSTERED INDEX [idx_PK_SowMart_Detail_data]
    ON [dbo].[cft_SowMart_Detail_data_stg]([FarmID] ASC, [SiteID] ASC, [GroupID] ASC, [IdentityID] ASC, [SowID] ASC, [SowParity] ASC, [mating_date] ASC) WITH (FILLFACTOR = 100);


GO
CREATE NONCLUSTERED INDEX [cfi_cft_sowmart_table_identityid]
    ON [dbo].[cft_SowMart_Detail_data_stg]([IdentityID] ASC, [mating_date] ASC) WITH (FILLFACTOR = 100);


GO
CREATE NONCLUSTERED INDEX [idx_cft_SowMart_Detail_data_4daily]
    ON [dbo].[cft_SowMart_Detail_data_stg]([FarmID] ASC, [mating_date] ASC, [farrow_date] ASC)
...
CREATE NONCLUSTERED INDEX [idx_cft_SowMart_Detail_data_rg_farrowweek_incl]
    ON [dbo].[cft_SowMart_Detail_data_stg]([reportinggroupid] ASC, [farrow_picyear_week] ASC)
...
CREATE UNIQUE NONCLUSTERED INDEX [idx_sowmart_detail_data_uniq]
    ON [dbo].[cft_SowMart_Detail_data_stg]([SiteID] ASC, [GroupID] ASC, [IdentityID] ASC, [SowParity] ASC, [mating_date] ASC) WITH (FILLFACTOR = 90);
