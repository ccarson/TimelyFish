CREATE TABLE [dbo].[cft_SowMart_weekly_Rollup_orig] (
...
CREATE UNIQUE CLUSTERED INDEX [idx_PK_cft_sowmart_weekly_rollup]
    ON [dbo].[cft_SowMart_weekly_Rollup_orig]([PicYear_week] ASC, [FarmID] ASC, [SiteID] ASC, [reportinggroupid] ASC) WITH (FILLFACTOR = 90);
