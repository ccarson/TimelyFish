...
-- Description:	Returns Service Managers by Period or PIC week
-- ==================================================================
CREATE PROCEDURE [dbo].[cfp_PIG_GROUP_ROLLUP_SVC_MGR_SELECT]
	@PhaseID char(3)
,	@PeriodOrWeek CHAR(1)
,	@Period char(7)
,	@PicDate char(6)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_PIG_GROUP_ROLLUP_SVC_MGR_SELECT] TO [db_sp_exec]
    AS [dbo];
