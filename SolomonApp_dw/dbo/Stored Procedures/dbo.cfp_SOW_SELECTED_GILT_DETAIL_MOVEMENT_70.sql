...
-- =============================================
CREATE PROCEDURE [dbo].[cfp_SOW_SELECTED_GILT_DETAIL_MOVEMENT_70]
(
	 @StartPeriod	int
	,@EndPeriod		int
...
BEGIN
	...
	Case when GFlow.Phase in ('SG','SB') then Sum(Movement.Movement)*0.70 else Sum(Movement.Movement) end as Movement,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_SOW_SELECTED_GILT_DETAIL_MOVEMENT_70] TO [db_sp_exec]
    AS [dbo];
