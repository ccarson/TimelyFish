...
-- ===================================================================
CREATE PROCEDURE [dbo].[cfp_SOW_SOWDAYS_GOODPIGS_INSERT_smr]
AS
BEGIN
...
--	left join Saturn.SowData.dbo.FarmSetup FS -- removed the saturn reference 20130905 as part of the saturn retirement
	left join SowData.dbo.FarmSetup FS
