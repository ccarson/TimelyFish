...
CREATE PROCEDURE [dbo].[cfp_REPORT_MORTALITY_EXCEPTION_DETAIL_BY_PIC_DATE]
	@PicDate				CHAR(6)
...
SELECT * FROM #ReportData ORDER BY SortOrder, PigFlowStartDate
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_MORTALITY_EXCEPTION_DETAIL_BY_PIC_DATE] TO [db_sp_exec]
    AS [dbo];
