...
-- =============================================
-- Author:		SRipley, dbo.cfp_REPORT_SLF_Mort_rpt1
-- Create date: 08/03/2010
-- Description:	This procedure provides the data for the StraightLineFlow Report
--
-- =============================================
CREATE PROCEDURE [dbo].[cfp_REPORT_SLF_Mort_rpt1]
...
--union
--select site.picyear_week, site.phase,  NULL, site.mortality as sitemortality, NULL as flowmortality, sitecontactid, null as targetmortality
...
-- union
--select flow.picyear_week,  flow.phase,  NULL as mortality, NULL as sitemortality,flow.mortality as  flowmortality, sitecontactid, null as targetmortality
...
union
select site.picyear_week, site.phase,  NULL, site.mortality as sitemortality, NULL, sitecontactid, NULL as targetmortality
from[dbo].[cft_RPT_PIG_MASTER_GROUP_DW] site (nolock)
where site.phase = @phase
  and site.picyear_week between @enddate and @picyear_week
  and site.sitecontactid = @sitecontactid
 union
select flow.picyear_week,  flow.phase,  NULL as sysmortality, NULL as sitemortality,flow.mortality as  flowmortality, sitecontactid, NULL as targetmortality
from[dbo].[cft_RPT_PIG_MASTER_GROUP_DW]  flow (nolock)
where  flow.phase = @phase
  and  flow.picyear_week between @enddate and @picyear_week
  and  flow.sitecontactid <> @sitecontactid
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_SLF_Mort_rpt1] TO [CorpReports]
    AS [dbo];
