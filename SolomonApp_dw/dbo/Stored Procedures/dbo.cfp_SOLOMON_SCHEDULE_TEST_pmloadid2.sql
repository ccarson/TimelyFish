...
-- =============================================
CREATE PROCEDURE [dbo].[cfp_SOLOMON_SCHEDULE_TEST_pmloadid2]
(
...
BEGIN
	...
	Sum(Boars+Abcess+BellyBust+RearRupture+Heavy+Lites+InsectBite+Tailbite) as 'ReSale',
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_SOLOMON_SCHEDULE_TEST_pmloadid2] TO [db_sp_exec]
    AS [dbo];
