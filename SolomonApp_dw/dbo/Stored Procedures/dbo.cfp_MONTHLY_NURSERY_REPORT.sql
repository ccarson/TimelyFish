...
CREATE PROCEDURE [dbo].[cfp_MONTHLY_NURSERY_REPORT]
	@PhaseID CHAR(3)
...
WHERE mgr.ActCloseDate BETWEEN @StartPeriod AND @EndPeriod
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_MONTHLY_NURSERY_REPORT] TO [db_sp_exec]
    AS [dbo];
