...
-- ===================================================================
CREATE PROCEDURE [dbo].[cfp_SOW_SERVICEMGR_KPI_INSERT_remove]
AS
BEGIN
...
(	Site
	...
	From earth.Sowdata.dbo.FarmSetup Farm	-- removed the saturn reference 
	...
	SF.WeekOfDate,
	Sum(Qty) Farrows
	from earth.SowData.dbo.vPM_SowsFarrowed SF	-- removed the saturn reference
	left join earth.SowData.dbo.FarmSetup FS	-- removed the saturn reference
	...
	ASF.WeekOfDate,
	Sum(Qty) ServeFarrow
	from earth.SowData.dbo.vPM_AdjServedtoFarrow ASF	-- removed the saturn reference
	left join earth.SowData.dbo.FarmSetup FS	-- removed the saturn reference
	...
	PBA.WeekOfDate,
	Sum(Qty) BornAlive
	from earth.SowData.dbo.vPM_PigsBornAlive PBA	-- removed the saturn reference
	left join earth.SowData.dbo.FarmSetup FS	-- removed the saturn reference
	...
	SBP.WeekOfDate,
	Sum(Qty) StillBorn
	from earth.SowData.dbo.vPM_StillBornPigs SBP	-- removed the saturn reference
	left join earth.SowData.dbo.FarmSetup FS	-- removed the saturn reference
	...
	MPB.WeekOfDate,
	Sum(Qty) Mummy
	from earth.SowData.dbo.vPM_MummifiedPigsBorn MPB	-- removed the saturn reference
	left join earth.SowData.dbo.FarmSetup FS	-- removed the saturn reference
	...
	LWD.WeekOfDate,
	Sum(Qty) SowWeaned
	from earth.SowData.dbo.vPM_LastWeanDatesQty LWD	-- removed the saturn reference
	left join earth.SowData.dbo.FarmSetup FS	-- removed the saturn reference
	...
	from earth.SowData.dbo.vPM_SowAndGiltDeaths SGD	-- removed the saturn reference
	left join earth.SowData.dbo.FarmSetup FS	-- removed the saturn reference
	...
	TSD.WeekOfDate,
	Sum(Qty) SowDays
	from earth.SowData.dbo.vPM_TotalSowDays TSD	-- removed the saturn reference
	left join earth.SowData.dbo.FarmSetup FS	-- removed the saturn reference
