...
-- ===================================================================
CREATE PROCEDURE [dbo].[cfp_SOW_SELECTED_GILT_MOVEMENT_INSERT]
AS
BEGIN
...
TRUNCATE TABLE  dbo.cft_SOW_SELECTED_GILT_MOVEMENT

--------------------------------------------------------------------------
-- BASE INFO
--------------------------------------------------------------------------
INSERT INTO  dbo.cft_SOW_SELECTED_GILT_MOVEMENT
(	SSite
	,DSite
	,DContactname
	,PigGradeCatTypeID
	...
	where s.Siteid='0511'
	and dc.Contactname in ('Pork Storks 1','Pork Storks 2','Pork Storks SD')
	and (tr.DocType is null or tr.DocType<>'RE')
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_SOW_SELECTED_GILT_MOVEMENT_INSERT] TO [db_sp_exec]
    AS [dbo];
