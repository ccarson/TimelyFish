...
CREATE PROCEDURE [dbo].[cfp_cube_Closeout_eb]
				@LOG char(1)='Y'
AS
BEGIN
/*
...
2016-02-29 BMD  Updated to exclude CF-SBF sale stub groups.  We don't want these in the cube.
				INSERT INTO #pg statement updated
===============================================================================
*/
...
where
	    PGStatusID='I'
	and PigGroupID not in ( -- Ignore all the stub CF pig groups closed out at the sale to SBF 2/6/2016
	...
	--and ActCloseDate>='12/28/2008' --Comment this out for Cube Year Rollover 1/8/2016 JLM
	and ActCloseDate>='1/1/2012' --This is to be used after 1/11/2017 for Close cube JLM
	and (
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_cube_Closeout_eb] TO [SE\ssis_datareader]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_cube_Closeout_eb] TO [SSRS_operator]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_cube_Closeout_eb] TO [SE\ssis_datawriter]
    AS [dbo];
