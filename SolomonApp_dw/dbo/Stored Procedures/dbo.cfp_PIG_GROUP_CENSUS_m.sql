...
CREATE PROCEDURE [dbo].[cfp_PIG_GROUP_CENSUS_m]
AS
BEGIN
...
truncate table  dbo.cft_PIG_GROUP_CENSUS_m

--------------------------------------------------------------------------
-- BASE INFO
--------------------------------------------------------------------------
INSERT INTO  dbo.cft_PIG_GROUP_CENSUS_m
(	PigGroupID
,	PigProdPhaseID
,	PhaseDesc
,	SiteContactID
...
FROM [$(CFApp_PigManagement)].dbo.cfv_PIG_GROUP_CENSUS_m cfv_PIG_GROUP_CENSUS

-- set pods
UPDATE cft_PIG_GROUP_CENSUS
SET PodDescription = cftPigProdPod.Description
FROM  dbo.cft_PIG_GROUP_CENSUS_m cft_PIG_GROUP_CENSUS (NOLOCK)
...
UPDATE dbo.cft_PIG_GROUP_CENSUS_m
