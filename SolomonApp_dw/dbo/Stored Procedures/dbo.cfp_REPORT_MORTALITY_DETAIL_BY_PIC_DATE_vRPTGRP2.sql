CREATE PROCEDURE 
	[dbo].[cfp_REPORT_MORTALITY_DETAIL_BY_PIC_DATE_vRPTGRP2]
		@PicDate			char(06)
...
FROM 
	 dbo.cft_PIG_GROUP_CENSUS AS cft_PIG_GROUP_CENSUS 
INNER JOIN 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_MORTALITY_DETAIL_BY_PIC_DATE_vRPTGRP2] TO [db_sp_exec]
    AS [dbo];
