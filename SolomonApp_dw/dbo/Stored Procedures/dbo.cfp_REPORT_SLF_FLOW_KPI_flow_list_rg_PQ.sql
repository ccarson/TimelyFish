...
--
-- =============================================
CREATE PROCEDURE [dbo].[cfp_REPORT_SLF_FLOW_KPI_flow_list_rg_PQ]
	@mg_week char(6)	
...
select ess.reportinggroupid ,   rg.[Reporting_Group_Description] + '     Head Sold: '+ cast(sum(prim_qty) as varchar(20)) as Reporting_Group_Description
