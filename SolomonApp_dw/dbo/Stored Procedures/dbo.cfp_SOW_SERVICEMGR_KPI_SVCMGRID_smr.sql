...
-- =============================================
CREATE PROCEDURE [dbo].[cfp_SOW_SERVICEMGR_KPI_SVCMGRID_smr]
(
	 @FYPeriod			int
...
BEGIN
	...
	From cfp_SOW_SERVICEMGR_KPI_SVCMGRID_smr Farm	-- removed the saturn reference 20130905 smr as part of the  saturn retirement 
