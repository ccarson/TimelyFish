...
-- =============================================
-- Author:		SRipley, dbo.cfp_REPORT_SLF_mort_rpt2_rg
-- Create date: 08/03/2010
-- Description:	This procedure provides the data for the StraightLineFlow Report
--
-- =============================================
CREATE PROCEDURE [dbo].[cfp_REPORT_SLF_mort_rpt2_rg]
...
group by flow.reportinggroupid, flow.picyear_week, flow.phase
 union
-- target numbers
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_SLF_mort_rpt2_rg] TO [db_sp_exec]
    AS [dbo];
