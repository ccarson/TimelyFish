...
-- Description:	Returns Inventory Var by Site
-- =============================================
CREATE PROCEDURE [dbo].[cfp_CLOSEOUT_INVENT_VAR]
(
...
BEGIN
	...
	Where DW.PICYear_Week between @StartPICYrWeek and @EndPICYrWeek
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CLOSEOUT_INVENT_VAR] TO [db_sp_exec]
    AS [dbo];
