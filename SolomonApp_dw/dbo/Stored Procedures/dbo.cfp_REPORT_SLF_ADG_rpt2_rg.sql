...
-- =============================================
-- Author:		SRipley, dbo.cfp_REPORT_SLF_ADG_rpt2_rg
-- Create date: 08/03/2010
-- Description:	This procedure provides the data for the StraightLineFlow Report
--
-- =============================================
CREATE PROCEDURE [dbo].[cfp_REPORT_SLF_ADG_rpt2_rg]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_SLF_ADG_rpt2_rg] TO [CorpReports]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_SLF_ADG_rpt2_rg] TO [db_sp_exec]
    AS [dbo];
