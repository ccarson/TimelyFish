...
-- =============================================
CREATE PROCEDURE dbo.cfp_DATA_MARKETING_SITE_PLAN_MARKET_LOAD_SINGLE_TOP 
	@PigGroupID Char(6) 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_DATA_MARKETING_SITE_PLAN_MARKET_LOAD_SINGLE_TOP] TO [db_sp_exec]
    AS [dbo];
