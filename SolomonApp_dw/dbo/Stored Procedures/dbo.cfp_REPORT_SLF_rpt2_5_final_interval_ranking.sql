...
--
-- =============================================
create PROCEDURE [dbo].[cfp_REPORT_SLF_rpt2_5_final_interval_ranking]
...
+ pf.PigFlowDescription as phaseflow
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_SLF_rpt2_5_final_interval_ranking] TO [CorpReports]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_SLF_rpt2_5_final_interval_ranking] TO [db_sp_exec]
    AS [dbo];
