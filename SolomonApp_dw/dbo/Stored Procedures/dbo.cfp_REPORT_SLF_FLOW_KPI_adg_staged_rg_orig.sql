...
--
-- =============================================
CREATE PROCEDURE [dbo].[cfp_REPORT_SLF_FLOW_KPI_adg_staged_rg_orig]
...
into #EA
	...
	--join #pf_list fid
	--	on fid.reportinggroupid = pf.reportinggroupid
	) xx
...
/ ( (26.0/49.0)*(w48w0.pdays) + ( (w51w26.ba*((w25w0.HS/#ea.gpw_per_sowwean)/#EA.litters_farrowed_qty) * ( (w48w23.wean_age * (1-w48w23.pwm) + ( 4 * w48w23.pwm)) ) ) )  )  as 'ADG rollup'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_SLF_FLOW_KPI_adg_staged_rg_orig] TO [db_sp_exec]
    AS [dbo];
