...
-- =============================================
-- Author:		SRipley, dbo.cfp_REPORT_APatel_SLF_ADG_rpt2.5
-- Create date: 08/03/2010
-- Description:	This procedure provides the data for the StraightLineFlow Report
--
-- =============================================
CREATE  PROCEDURE [dbo].[cfp_REPORT_APatel_SLF_rpt2_5_rg]
...
select mg.picyear_week, mg.sitecontactid,mg.reportinggroupid, mg.pigflowid, mg.phase
...
where mg.sitecontactid is not null-- mg.sitecontactid = @sitecontactid
...
select ssi.phase, ssi.reportinggroupid, ssi.pigflowid, ssi.daterange,ssi.picyear_week,dw.sitecontactid
...
group by ssi.phase, ssi.reportinggroupid,ssi.pigflowid, ssi.daterange,ssi.picyear_week, dw.sitecontactid
--
...
where 1=1 --sitecontactid =  @sitecontactid
  and contactname <> ''
  ...
  select --site.picyear_week as site_closeout_picyear_week
--  pct.daterange
 pct.contactname	--, pct.sitecontactid, pct.phase
...
left join #slf_averages sav
	on sav.daterange = pct.daterange and sav.sitecontactid = pct.sitecontactid  and sav.reportinggroupid = pct.reportinggroupid and sav.phase = pct.phase
where pct.comps >= 0
--and pct.daterange = '14WK01_14WK17' and pct.phase = 'FIN' and pf.reportinggroupid = '23'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_APatel_SLF_rpt2_5_rg] TO [CorpReports]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_APatel_SLF_rpt2_5_rg] TO [db_sp_exec]
    AS [dbo];
