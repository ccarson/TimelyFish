...
--
-- =============================================
CREATE  PROCEDURE [dbo].[cfp_REPORT_SLF_rpt2_5]
...
, site.nbrevals, site.picyear_week + '_' +  pf.PigFlowDescription  as picyear_week
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_SLF_rpt2_5] TO [CorpReports]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_SLF_rpt2_5] TO [db_sp_exec]
    AS [dbo];
