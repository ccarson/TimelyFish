...
CREATE PROCEDURE [dbo].[cfp_REPORT_SITE_CLOSEOUT_BD]
...
SET @PicYear = (Select Distinct PICYEAR From [$(SolomonApp)].dbo.cfvDayDefinition_WithWeekInfo Where DayDate = @CloseDate)
SET @PicWeek = (Select Distinct PICWEEK From [$(SolomonApp)].dbo.cfvDayDefinition_WithWeekInfo Where DayDate = @CloseDate)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_SITE_CLOSEOUT_BD] TO [db_sp_exec]
    AS [dbo];
