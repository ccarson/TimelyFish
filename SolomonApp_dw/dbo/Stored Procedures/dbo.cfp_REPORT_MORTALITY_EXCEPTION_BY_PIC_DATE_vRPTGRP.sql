...
CREATE PROCEDURE [dbo].[cfp_REPORT_MORTALITY_EXCEPTION_BY_PIC_DATE_vRPTGRP]
	@PicDate CHAR(6)
,	@NumWeeks int
...
,	ME.MortExcept
,	cft_PIG_FLOW.reportinggroupid		-- 201312 smr reporting group enhancement
FROM  dbo.cft_PIG_GROUP_CENSUS cft_PIG_GROUP_CENSUS (NOLOCK)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_REPORT_MORTALITY_EXCEPTION_BY_PIC_DATE_vRPTGRP] TO [db_sp_exec]
    AS [dbo];
