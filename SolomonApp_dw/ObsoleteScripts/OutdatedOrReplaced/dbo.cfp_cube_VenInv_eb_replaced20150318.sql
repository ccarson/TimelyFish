...
CREATE  PROCEDURE [dbo].[cfp_cube_VenInv_eb_replaced20150318]
					@LOG char(1)='Y'
AS
BEGIN
/*
...
SET @ProcessName        = 'cfp_cube_VenInv_eb_replaced20150318'
SET @ProcessStatus      = 0
...
cost)
	...
	and it.ExtCost<>0
	and (
			(it.trantype in ('ii','ri') and it.acct in ('46100','46110','46700','46710','60100','62100','62105','66100','71200','71420','73450'))
				or
			(it.trantype  in ('in','cm') and it.COGSAcct in ('46100','46110','46700','46710','60100','62100','62105','66100','71420','71200','73450'))
			)
	UNION ALL
	...
	and ap.acct in ('46100','46110','46700','46710','60100','62100','62105','66100','71200','71420','73450')
	...
	and po.acct in ('46100','46110','46700','46710','60100','62100','62105','66100','71200','71420','73450')
	UNION ALL
	...
	and gl.acct in ('46100','46110','46700','46710','60100','62100','62105','66100','71200','71420','73450')
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_cube_VenInv_eb_replaced20150318] TO [SE\ssis_datareader]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_cube_VenInv_eb_replaced20150318] TO [SSRS_operator]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_cube_VenInv_eb_replaced20150318] TO [SE\ssis_datawriter]
    AS [dbo];
