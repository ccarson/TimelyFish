...
CREATE  PROCEDURE [dbo].[cfp_cube_Closeout_eb_20150223]
					@LOG char(1)='Y'
AS
BEGIN
/*
...
SELECT
	...
	case when isnull(pf.PigFlowID,0) = 0 and isnull(#pg.cf08,0) = 0 then  'PF_Other'
		 ...
		 when pf.PigFlowID is not null						then  'PF_'+rtrim(pf2.PigFlowDescription)
...
-------------------------------------------------------------------------------
-- Load cft_ESSBASE_CLOSEOUT_PAYLEAN_XREF
-------------------------------------------------------------------------------
...
select pg.TaskID,cast(pg.ActStartDate as int)+2 FiscalStartDate,
...
--,FirstPayleanDate bigint null
--,DaysOnPaylean bigint null
--,FiscalStartDate bigint null
--,PigStartDate bigint null
--,PigEndDate bigint null
--,HdCapacity int null
--)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_cube_Closeout_eb_20150223] TO [SE\ssis_datareader]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_cube_Closeout_eb_20150223] TO [SSRS_operator]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_cube_Closeout_eb_20150223] TO [SE\ssis_datawriter]
    AS [dbo];
