...
CREATE View IRItemSiteReplenVar AS
-- Note - Cross join between Inventory and Site is DELIBRATE, since ItemSite does not have every entry!
Select 
	Inventory.InvtID,
	Site.SiteID,
...
From 
	Inventory 
	CROSS JOIN Site
	Left Outer Join ItemSite On ItemSite.SiteID = Site.SiteID And ItemSite.InvtID = Inventory.InvtID
