...
CREATE VIEW VP_Return_AvailSerNbr 
AS 
SELECT *  FROM LotSerMst M WHERE
            ---*** Filter out Serial Nbr which are on Transfer..............
		M.LotSerNbr Not In (Select T.LotSerNbr From LotSerT T Where T.TranType = 'TR' and T.BatNbr In (
													Select R.BatNbr from trnsfrdoc R,Batch B
													Where R.BatNbr = B.BatNbr 
													and B.BatType = 'N'
													and B.Rlsed = 1 And R.transfertype=2
													AND R.S4Future11 = ''
													AND R.RcptNbr = '' 
													) 
           ...
           AND M.LotSerNbr Not In (Select T.LotSerNbr From LotSerT T Where T.TranType = 'RI' and T.BatNbr in (
                       											Select I.BatNbr From InTran I,Batch B 
