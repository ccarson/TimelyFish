...
--	Parms:
--*************************************************************
CREATE VIEW [dbo].[cfv_REPORT_INTERSTATE_PIG_MOVEMENTS_old]
AS
SELECT   Distinct 
...
dbo.getVetLastVisit(pm.SourceContactID, h.VetContactID, pm.MovementDate) VetVisitDate,
...
h.VetContactID,
h.Age,
pt.PigTypeDesc,v.ContactID,v.ContactName,vacc.AccreditationNumber,w.PICWeek,w.WeekOfDate,h.Tattoo, 
