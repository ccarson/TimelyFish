...
CREATE VIEW vp_08400ARReleaseDocsHist AS

SELECT 	v.UserAddress, h.FiscYr, h.CustId, v.CpnyID, 
  ...
  FROM vp_08400ARbalancesHist v, ARHist h
 WHERE h.FiscYr = v.FiscYr AND v.CustId = h.CustId AND v.CpnyID = h.CpnyID
 GROUP BY v.UserAddress, h.FiscYr, h.CustId, v.CpnyID
