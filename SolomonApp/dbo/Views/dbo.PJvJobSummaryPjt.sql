...
FROM         dbo.PJACTSUM INNER JOIN
                      dbo.PJJOBSUMMARYWrk ON dbo.PJACTSUM.project = dbo.PJJOBSUMMARYWrk.project LEFT OUTER JOIN
...
FROM         dbo.PJPTDSUM INNER JOIN
                      dbo.PJJOBSUMMARYWrk ON dbo.PJPTDSUM.project = dbo.PJJOBSUMMARYWrk.project LEFT OUTER JOIN
...
SELECT       dbo.PJPTDROL.acct AS acct, 0 AS amount_01, 0 AS amount_02, 0 AS amount_03, 0 AS amount_04, 0 AS amount_05, 0 AS amount_06, 0 AS amount_07,
                      ...
                      dbo.PJPOOLH.rate_ptd as rate_ptd, dbo.pjacct.ca_id06 as target_rt, SPACE(0) as task, pjproj.gl_subacct as subacct, SPACE(0) as com_amount, pjacct.sort_num, PJJOBSUMMARYWrk.ri_id,
                      dbo.pjproj.CpnyId, RptCompany.CpnyName
FROM         dbo.PJPTDROL INNER JOIN
                      dbo.PJJOBSUMMARYWrk ON dbo.PJPTDROL.project = dbo.PJJOBSUMMARYWrk.project LEFT OUTER JOIN
                      ...
                      dbo.RptCompany ON dbo.PJPROJ.CpnyId = dbo.RptCompany.CpnyID and dbo.PJJOBSUMMARYWrk.ri_id = dbo.RptCompany.RI_ID LEFT OUTER JOIN
                      dbo.PJPROJEX ON dbo.PJPTDROL.project = dbo.PJPROJEX.project LEFT OUTER JOIN
                      dbo.Customer ON dbo.PJPROJ.customer = dbo.Customer.CustId LEFT OUTER JOIN
