...
--	Author: Charity
--	Date: 08/23/2005
--	Usage: Pig Transport Reports
--	Parms: --
--*************************************************************
CREATE      VIEW dbo.cfvPMTranspRecDetail

AS

Select  Distinct lt.SourcePigGroupID, lt.DestPigGroupID,lt.RefNbr, lt.OrigRefNbr, lt.MovementDate,lt.SourceContactID, lt.DestContactID,
	...
	lt.DestFarmQty,lt.SubTypeID,lt.PigGenderTypeID,
	...
	where (lt.RecountQty>0 or lt.DestFarmQty>0) and
