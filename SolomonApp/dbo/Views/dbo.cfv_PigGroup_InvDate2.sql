...
CREATE VIEW cfv_PigGroup_InvDate2 (Company, PhaseDesc, FacilityType, SiteName, Status, GroupID, GroupDesc, Gender,
...
AS
SELECT	pg.CpnyID AS Company, ph.PhaseDesc, sd.FacilityType, sd.SiteName, 
