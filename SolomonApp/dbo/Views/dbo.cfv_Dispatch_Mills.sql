...
CREATE   VIEW [dbo].[cfv_Dispatch_Mills] (Address1, Address2, AddressID, City, ContactName, MillId, State, Zip,Phone, Email, Tstamp)
	AS
...
*/
	...
	SELECT Coalesce(a.Address1, ''), Coalesce(a.Address2, ''), Coalesce(a.AddressID, ''), 
		...
		c.ContactID, Coalesce(a.State, ''), Coalesce(a.Zip, '')
