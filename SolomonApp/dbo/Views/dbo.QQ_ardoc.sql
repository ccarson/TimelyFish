...
CREATE VIEW [QQ_ardoc]
AS
SELECT     
     a.BatNbr AS [Batch Number], a.Rlsed AS [Released], a.Status AS [Document Status],a.RefNbr As [Reference Number], a.CustId AS [Customer ID],
     ...
     a.OrigDocNbr AS [Original Document Number], a.PC_Status AS [Project Controller Status], a.PerClosed AS [Period Closed], a.PerEnt AS [Period Entered], 
     a.PerPost AS [Period Posted], a.PmtMethod AS [Payment Method], a.ProjectID, a.RGOLAmt AS [Realized Gain/Loss Amount],  
