...
--	Date: 11/22/2004
--	Usage: Pig Transport Wean Report CF610
--	Parms: --
--*************************************************************
CREATE  VIEW dbo.cfv610PMTranspRecord

AS

Select  Distinct lt.RefNbr, lt.OrigRefNbr, lt.MovementDate,lt.SourceContactID, lt.DestContactID,
