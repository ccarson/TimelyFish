...
GO
CREATE UNIQUE NONCLUSTERED INDEX [RQPolicyAuth0]
    ON [dbo].[RQPolicyAuth]([PolicyID] ASC, [DocType] ASC, [RequestType] ASC, [MaterialType] ASC, [Authority] ASC, [UserID] ASC);
