CREATE TABLE [dbo].[Approver] (
    [Approver1]     UNIQUEIDENTIFIER NOT NULL,
    [Approver2]     UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [Approver0] PRIMARY KEY CLUSTERED ([Approver1] ASC, [EmpId] ASC) WITH (FILLFACTOR = 90)
);
