CREATE TABLE [dbo].[PayDate] (
    ...
    [EmpleFederal]  FLOAT (53)    NOT NULL,
    [EmpleFICA]     FLOAT (53)    NOT NULL,
    [EmplrFICA]     FLOAT (53)    NOT NULL,
    ...
    CONSTRAINT [PayDate0] PRIMARY KEY CLUSTERED ([CalYr] ASC, [CalQtr] ASC, [ChkDate] ASC, [CpnyID] ASC) WITH (FILLFACTOR = 90)
);
