CREATE TABLE [dbo].[XDDEdiSegmentV] (
    ...
    [Section]       CHAR (3)      DEFAULT ('') NOT NULL,
    ...
    CONSTRAINT [XDDEdiSegmentV0] PRIMARY KEY CLUSTERED ([VendID] ASC, [VendAcct] ASC, [EntryClass] ASC, [EDIVersion] ASC, [Section] ASC, [SeqNbr] ASC)
);
