CREATE TABLE [dbo].[Budget_Group] (
    ...
    CONSTRAINT [Budget_group0] PRIMARY KEY NONCLUSTERED ([CpnyID] ASC, [BudgetYear] ASC, [BudgetLedgerID] ASC, [BdgtSegment] ASC, [GroupID] ASC) WITH (FILLFACTOR = 90)
);
