...
GO
CREATE NONCLUSTERED INDEX [RQProjAppr1]
    ON [dbo].[RQProjAppr]([Project] ASC) WITH (FILLFACTOR = 90);


GO
CREATE UNIQUE NONCLUSTERED INDEX [RQProjAppr0]
    ON [dbo].[RQProjAppr]([Project] ASC, [DocType] ASC, [RequestType] ASC, [Budgeted] ASC, [Authority] ASC);
