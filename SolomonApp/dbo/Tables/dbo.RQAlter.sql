CREATE TABLE [dbo].[RQAlter] (
    [AlterNbr]      CHAR (10)     NOT NULL,
    [AlterType]     CHAR (1)      NOT NULL,
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [RQAlter0]
    ON [dbo].[RQAlter]([AlterNbr] ASC, [AlterType] ASC);
