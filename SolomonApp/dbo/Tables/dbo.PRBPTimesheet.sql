CREATE TABLE [dbo].[PRBPTimesheet] (
    ...
    CONSTRAINT [PRBPTimesheet0] PRIMARY KEY CLUSTERED ([BatNbr] ASC, [ChkAcct] ASC, [ChkSub] ASC, [RefNbr] ASC, [TranType] ASC, [LineNbr] ASC) WITH (FILLFACTOR = 90)
);
