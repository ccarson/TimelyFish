CREATE TABLE [dbo].[PJACTSUM] (
    ...
    CONSTRAINT [pjactsum0] PRIMARY KEY CLUSTERED ([fsyear_num] ASC, [project] ASC, [pjt_entity] ASC, [acct] ASC)
);


GO
CREATE NONCLUSTERED INDEX [pjactsum1]
    ON [dbo].[PJACTSUM]([project] ASC, [pjt_entity] ASC, [acct] ASC) WITH (FILLFACTOR = 100);
