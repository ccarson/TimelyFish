...
GO
CREATE UNIQUE NONCLUSTERED INDEX [RQApprHist0]
    ON [dbo].[RQApprHist]([Auth_Type] ASC, [Auth_ID] ASC, [DocType] ASC, [Authority] ASC, [EffBegDate] ASC, [EffEndDate] ASC, [Budgeted] ASC, [MaterialType] ASC, [RequestType] ASC);
