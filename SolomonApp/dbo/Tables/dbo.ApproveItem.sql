CREATE TABLE [dbo].[ApproveItem] (
    ...
    CONSTRAINT [ApproveItem0] PRIMARY KEY CLUSTERED ([RecordID] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [ApproveItem1]
    ON [dbo].[ApproveItem]([Approver] ASC, [Action_DateTime] ASC, [Action] ASC, [EmpId] ASC, [RefNbr] ASC, [LineNbr] ASC) WITH (FILLFACTOR = 90);
