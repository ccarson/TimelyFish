CREATE TABLE [dbo].[PJBUDROL] (
    ...
    CONSTRAINT [pjbudrol0] PRIMARY KEY CLUSTERED ([fsyear_num] ASC, [project] ASC, [acct] ASC, [PlanNbr] ASC)
);


GO
CREATE NONCLUSTERED INDEX [pjbudrol1]
    ON [dbo].[PJBUDROL]([project] ASC, [acct] ASC);
