CREATE TABLE [dbo].[XDDBatchARLBApplic] (
    [ApplyAmount]     FLOAT (53)    DEFAULT (0) NOT NULL,
    ...
    [DiscApplyAmount] FLOAT (53)    DEFAULT (0) NOT NULL,
    ...
    [PmtRecordID]     INT           DEFAULT (0) NOT NULL,
    ...
    CONSTRAINT [XDDBatchARLBApplic0] PRIMARY KEY CLUSTERED ([LBBatNbr] ASC, [CustID] ASC, [PmtRecordID] ASC, [LineNbr] ASC)
);
