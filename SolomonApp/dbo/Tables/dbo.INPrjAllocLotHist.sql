CREATE TABLE [dbo].[INPrjAllocLotHist] (
    ...
    [TranSrcDate]       SMALLDATETIME DEFAULT ('01/01/1900') NOT NULL,
    [TranSrcLineRef]    CHAR (5)      DEFAULT (' ') NOT NULL,
    [TranSrcNbr]        CHAR (15)     DEFAULT (' ') NOT NULL,
    [TranSrcType]       CHAR (3)      DEFAULT (' ') NOT NULL,
    ...
    CONSTRAINT [INPrjAllocLotHist0] PRIMARY KEY CLUSTERED ([SrcType] ASC, [SrcNbr] ASC, [SrcLineRef] ASC, [TranSrcType] ASC, [TranSrcNbr] ASC, [TranSrcLineRef] ASC, [LotSerNbr] ASC, [LotSerRef] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [INPrjAllocLotHist1]
    ON [dbo].[INPrjAllocLotHist]([InvtID] ASC, [SiteID] ASC) WITH (FILLFACTOR = 90);
