CREATE TABLE [dbo].[APCheck] (
    ...
    CONSTRAINT [APCheck0] PRIMARY KEY CLUSTERED ([BatNbr] ASC, [Acct] ASC, [Sub] ASC, [CheckRefNbr] ASC, [RecordID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [APCheck1]
    ON [dbo].[APCheck]([CheckNbr] ASC, [CheckType] ASC, [Acct] ASC, [Sub] ASC);
