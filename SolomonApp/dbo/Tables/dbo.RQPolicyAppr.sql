...
GO
CREATE NONCLUSTERED INDEX [RQpolicyAppr1]
    ON [dbo].[RQPolicyAppr]([PolicyID] ASC) WITH (FILLFACTOR = 90);


GO
CREATE UNIQUE NONCLUSTERED INDEX [RQpolicyAppr0]
    ON [dbo].[RQPolicyAppr]([PolicyID] ASC, [DocType] ASC, [RequestType] ASC, [MaterialType] ASC, [Authority] ASC);
