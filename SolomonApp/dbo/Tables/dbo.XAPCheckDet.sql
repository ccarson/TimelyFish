CREATE TABLE [dbo].[XAPCheckDet] (
    ...
    [CuryGrossAmt]  FLOAT (53)    NOT NULL,
    ...
    CONSTRAINT [XAPCheckDet0] PRIMARY KEY CLUSTERED ([BatNbr] ASC, [CheckRefNbr] ASC, [RecordID] ASC) WITH (FILLFACTOR = 90)
);
