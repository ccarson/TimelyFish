CREATE TABLE [dbo].[PJProjEDDReceiver] (
    ...
    CONSTRAINT [PJProjEDDReceiver0] PRIMARY KEY CLUSTERED ([CpnyID] ASC, [Project] ASC, [DocType] ASC, [LineNbr] ASC) WITH (FILLFACTOR = 90)
);
