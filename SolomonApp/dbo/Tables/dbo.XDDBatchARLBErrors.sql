CREATE TABLE [dbo].[XDDBatchARLBErrors] (
    [Acct]          CHAR (10)     DEFAULT ('') NOT NULL,
    [Amount]        FLOAT (53)    DEFAULT ((0)) NOT NULL,
    [AmountChgd]    FLOAT (53)    DEFAULT ((0)) NOT NULL,
    ...
    [DiscApplyAmt]  FLOAT (53)    DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [XDDBatchARLBErrors0] PRIMARY KEY CLUSTERED ([LBBatNbr] ASC, [CustID] ASC, [LineNbr] ASC, [RecordID] ASC)
);
