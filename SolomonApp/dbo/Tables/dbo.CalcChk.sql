CREATE TABLE [dbo].[CalcChk] (
    ...
    [CurrStdRate]   FLOAT (53)    NOT NULL,
    [DetailLines]   SMALLINT      NOT NULL,
    ...
    CONSTRAINT [CalcChk0] PRIMARY KEY CLUSTERED ([EmpID] ASC, [ChkSeq] ASC) WITH (FILLFACTOR = 90)
);
