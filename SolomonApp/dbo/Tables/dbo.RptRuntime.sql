CREATE TABLE [dbo].[RptRuntime] (
    ...
    CONSTRAINT [RptRuntime0] PRIMARY KEY CLUSTERED ([RI_ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [RptRuntime1]
    ON [dbo].[RptRuntime]([ComputerName] ASC, [UserId] ASC);
