CREATE TABLE [dbo].[PJACTROL] (
    ...
    CONSTRAINT [pjactrol0] PRIMARY KEY CLUSTERED ([fsyear_num] ASC, [project] ASC, [acct] ASC) WITH (FILLFACTOR = 100)
);


GO
CREATE NONCLUSTERED INDEX [pjactrol1]
    ON [dbo].[PJACTROL]([project] ASC, [acct] ASC) WITH (FILLFACTOR = 100);
