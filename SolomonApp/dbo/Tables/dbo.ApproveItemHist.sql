CREATE TABLE [dbo].[ApproveItemHist] (
    ...
    CONSTRAINT [ApproveItemHist0] PRIMARY KEY CLUSTERED ([RecordID] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [ApproveItemHist1]
    ON [dbo].[ApproveItemHist]([Approver] ASC, [Action_DateTime] ASC, [Action] ASC, [EmpId] ASC, [RefNbr] ASC, [LineNbr] ASC) WITH (FILLFACTOR = 90);
