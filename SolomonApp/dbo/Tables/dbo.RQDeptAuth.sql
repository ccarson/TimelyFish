...
GO
CREATE CLUSTERED INDEX [RQDeptAuth1]
    ON [dbo].[RQDeptAuth]([UserID] ASC, [DocType] ASC) WITH (FILLFACTOR = 90);


GO
CREATE UNIQUE NONCLUSTERED INDEX [RQDeptAuth0]
    ON [dbo].[RQDeptAuth]([DeptID] ASC, [DocType] ASC, [RequestType] ASC, [Budgeted] ASC, [Authority] ASC, [UserID] ASC) WITH (FILLFACTOR = 90);
