CREATE TABLE [dbo].[PJBUDSUM] (
    ...
    [ProjCury_total_amt] FLOAT (53)    NOT NULL,
    ...
    CONSTRAINT [pjbudsum0] PRIMARY KEY CLUSTERED ([fsyear_num] ASC, [project] ASC, [pjt_entity] ASC, [acct] ASC, [planNbr] ASC)
);


GO
CREATE NONCLUSTERED INDEX [pjbudsum1]
    ON [dbo].[PJBUDSUM]([project] ASC, [pjt_entity] ASC, [acct] ASC);
