CREATE TABLE [dbo].[INPrjAllocTranHist] (
    [ActualCost]     FLOAT (53)    DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [INPrjAllocTranHist0] PRIMARY KEY CLUSTERED ([SrcType] ASC, [SrcNbr] ASC, [SrcLineRef] ASC, [TranSrcType] ASC, [TranSrcNbr] ASC, [TranSrcLineRef] ASC) WITH (FILLFACTOR = 90)
);
