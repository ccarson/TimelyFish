CREATE TABLE [dbo].[W2EmpName] (
    ...
    [NameMiddle]    CHAR (15)     NOT NULL,
    [NameSuffix]    CHAR (4)      NOT NULL,
    [NoteID]        INT           NOT NULL,
    ...
    CONSTRAINT [W2EmpName0] PRIMARY KEY CLUSTERED ([EmpId] ASC) WITH (FILLFACTOR = 90)
);
