 /****** Object:  Stored Procedure dbo.BUDetail_ArrLoad_Assets    Script Date: 11/22/99 12:38:58 PM ******/
CREATE PROCEDURE BUDetail_ArrLoad_Assets
...
((ABS(PTDBal00) + ABS(PTDBal01) + ABS(PTDBal02) +  ABS(PTDBal03) + ABS(PTDBal04) + ABS(PTDBal05) +
 ...
 Account.AcctType IN ('1A', '2A', '3A', '4A')
