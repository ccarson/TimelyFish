 /****** Object:  Stored Procedure dbo.InvtCustPrice_Price_GroupSite    Script Date: 1/12/08 12:30:33 PM ******/
CREATE PROCEDURE InvtCustPrice_Price_GroupSite
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[InvtCustPrice_Price_GroupSite] TO [MSDSL]
    AS [dbo];
