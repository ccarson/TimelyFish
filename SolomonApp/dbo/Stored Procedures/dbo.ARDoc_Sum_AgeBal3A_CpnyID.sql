...
Create proc ARDoc_Sum_AgeBal3A_CpnyID @parm1 varchar ( 15), @parm2 varchar ( 10), @parm3 smalldatetime, @parm4 smalldatetime, @parm5 varchar ( 6) As
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[ARDoc_Sum_AgeBal3A_CpnyID] TO [MSDSL]
    AS [dbo];
