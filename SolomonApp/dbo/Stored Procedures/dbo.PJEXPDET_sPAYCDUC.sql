 create procedure PJEXPDET_sPAYCDUC  @parm1 varchar (4) , @parm2 smalldatetime , @parm3 smalldatetime , @parm4 varchar (10), @parm5 varchar(10), @parm6 varchar(100) 
...
select PJEXPDET.*,PJEXPHDR.*,PJEXPTYP.*,PJEMPLOY.*
	...
	where PJEXPDET.docnbr  = PJEXPHDR.docnbr
		...
		and (PJEXPDET.td_id03 = ' ' and PJEXPDET.amt_company <> 0)
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[PJEXPDET_sPAYCDUC] TO [MSDSL]
    AS [dbo];
