 Create Procedure ARDoc_Batch_Custid_Rlsed @parm1 varchar ( 15), @parm2 varchar(47), @parm3 varchar(7), @parm4 varchar(1)
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[ARDoc_Batch_Custid_Rlsed] TO [MSDSL]
    AS [dbo];
