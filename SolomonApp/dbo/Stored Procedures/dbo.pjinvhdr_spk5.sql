 Create Procedure pjinvhdr_spk5 @parm1 varchar (10), @parm2 smalldatetime , @parm3 varchar (10) , @parm4 varchar (24), @parm5 varchar(6), @parm6 varchar(4)  as
...
(h.fiscalno = '' or h.fiscalno = @parm5) and
p.billcuryid = @parm6
ORDER BY
h.inv_status
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[pjinvhdr_spk5] TO [MSDSL]
    AS [dbo];
