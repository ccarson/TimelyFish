...
CREATE PROCEDURE pb_08810 @RI_ID SMALLINT
...
SELECT @Search = "({vr_08810.PerPost} >= '" + @BegPerNbr + "' AND {vr_08810.PerPost} <= '" + @EndPerNbr + "' AND {vr_08810.cRI_ID} = " + RTRIM(CONVERT(VARCHAR(6),@RI_ID)) + ")"
