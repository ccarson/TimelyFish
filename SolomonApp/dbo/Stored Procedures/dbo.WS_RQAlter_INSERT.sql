CREATE PROCEDURE WS_RQAlter_INSERT
            @AlterNbr char(10), @AlterType char(1), @crtd_datetime smalldatetime, @crtd_prog char(8), @crtd_user char(10),
            @lupd_datetime smalldatetime, @lupd_prog char(8), @lupd_user char(10), @S4Future1 char(30), @S4Future2 char(30),
            ...
            BEGIN
            INSERT INTO [RQAlter]
            ([AlterNbr], [AlterType], [crtd_datetime], [crtd_prog], [crtd_user],
            [lupd_datetime], [lupd_prog], [lupd_user], [S4Future1], [S4Future2], 
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[WS_RQAlter_INSERT] TO [MSDSL]
    AS [dbo];
