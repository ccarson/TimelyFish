 /****** Object:  Stored Procedure dbo.BUDetail_ArrLoad_InEx    Script Date: 11/22/99 12:38:58 PM ******/
CREATE PROCEDURE BUDetail_ArrLoad_InEx
...
((ABS(PTDBal00) + ABS(PTDBal01) + ABS(PTDBal02) +  ABS(PTDBal03) + ABS(PTDBal04) + ABS(PTDBal05) +
 ...
 Account.AcctType IN ('1I', '2I', '3I', '4I','1E', '2E', '3E', '4E')
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[BUDetail_ArrLoad_InEx] TO [MSDSL]
    AS [dbo];
