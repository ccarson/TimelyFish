...
While @Counter <= @EndCount
	...
	Insert Into #Results
	Exec SolomonApp_dw.dbo.cfp_DATA_MARKETING_DISTRIBUTION_PIGGROUP @PigGroupID
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[cfp_REPORT_MASTERGROUP_MARKETING_DISTRIBUTION_PIGDATA] TO [MSDSL]
    AS [dbo];
