...
create procedure PMG_TableConvert
...
as
	...
	if @NewColCnt = @NewJoinCnt and @OldColCnt = @OldJoinCnt and @NewColCnt = @OldColCnt and @StrLenDifCnt =0 begin
	...
	select @OldTableRename = "PMGOld" + substring(@OldTable,1,24)
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[PMG_TableConvert] TO [MSDSL]
    AS [dbo];
