...
Create PROC Get_ProjectInvt_SOLine
	@CpnyID		varchar(10),
	@OrdNbr		varchar(15),
    @LineRef    varchar(5)
...
AS
  ...
  SELECT s.InvtID, s.LineRef, s.OrdNbr, s.ProjectID, s.SiteID, s.TaskID, s.AutoPO, s.DropShip, s.Sample, t.Behavior, s.QtyOrd
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[Get_ProjectInvt_SOLine] TO [MSDSL]
    AS [dbo];
