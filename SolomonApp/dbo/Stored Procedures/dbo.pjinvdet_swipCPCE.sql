 Create Procedure pjinvdet_swipCPCE @parm1 varchar (10), @parm2 varchar (16) , @parm3 smalldatetime, @parm4 varchar (15)        as
select pjinvdet.*,
	pjpent.*,
	pjproj.*,
...
order by pjinvdet.project, pjinvdet.acct,pjinvdet.employee, pjinvdet.vendor_num, pjinvdet.source_trx_date



GO
GRANT CONTROL
    ON OBJECT::[dbo].[pjinvdet_swipCPCE] TO [MSDSL]
    AS [dbo];
