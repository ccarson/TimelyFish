CREATE PROCEDURE WS_PJPTDSUM_INSERT
...
@fac_amount float,@fac_units float,@lupd_datetime smalldatetime,@lupd_prog char(8),@lupd_user char(10),@noteid int,@pjt_entity char(32),
...
@project char(16),@rate float,@total_budget_amount float,@total_budget_units float,@user1 char(30),@user2 char(30),@user3 float,@user4 float
AS
BEGIN
INSERT INTO [PJPTDSUM]
([acct], [act_amount],[act_units],[com_amount],[com_units],[crtd_datetime],[crtd_prog],[crtd_user],[data1],[data2],[data3],[data4],[data5],
[eac_amount],[eac_units],[fac_amount],[fac_units],[lupd_datetime],[lupd_prog],[lupd_user],[noteid],[pjt_entity],
