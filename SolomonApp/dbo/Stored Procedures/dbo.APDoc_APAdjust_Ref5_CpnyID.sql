 Create Procedure APDoc_APAdjust_Ref5_CpnyID @parm1 varchar ( 15), @parm2 varchar ( 10), @parm3 varchar ( 6) As
Select
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[APDoc_APAdjust_Ref5_CpnyID] TO [MSDSL]
    AS [dbo];
