 CREATE Proc EDLogSendASNEvent @CpnyId varchar(10), @Descr varchar(30), @OrdNbr varchar(15), @ShipperId varchar(15), @UserId varchar(10) As
...
select @CpnyId, getdate(), '', '', @Descr, getdate(), getdate(),'NSHP', @invcnbr, getdate(), '', '', 0, @OrdNbr, '50402',
'', '', 0, 0, 0, 0,'', '', 0, 0, '', '',
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[EDLogSendASNEvent] TO [MSDSL]
    AS [dbo];
