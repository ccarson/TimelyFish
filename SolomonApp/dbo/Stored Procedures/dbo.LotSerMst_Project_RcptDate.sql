Create Proc LotSerMst_Project_RcptDate @parm1 varchar ( 30), @parm2 varchar (10), @parm3 varchar (10), @parm4 varchar (16), @parm5 varchar (32), @parm6 varchar (25) as
    Select l.* from LotSerMst l Inner Join InvProjAllocLot i ON
                  ...
                  Where i.InvtiD = @parm1
                    ...
                    order by l.Invtid,l.RcptDate,l.LotSerNbr



GO
GRANT CONTROL
    ON OBJECT::[dbo].[LotSerMst_Project_RcptDate] TO [MSDSL]
    AS [dbo];
