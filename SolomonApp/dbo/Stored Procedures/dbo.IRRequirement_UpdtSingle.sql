 CREATE Procedure IRRequirement_UpdtSingle @InvtID VarChar(30), @DocumentID VarChar(30), @DocumentType VarChar(3), @DocOtherRef1 VarChar(30), @DueDate SmallDateTime, @SiteID VarChar(10), @DocOtherRef2 VarChar(30), @Revised SmallInt As
