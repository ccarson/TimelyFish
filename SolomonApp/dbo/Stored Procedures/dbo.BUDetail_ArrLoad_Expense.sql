 /****** Object:  Stored Procedure dbo.BUDetail_ArrLoad_Expense    Script Date: 11/26/99 12:38:58 PM ******/
CREATE PROCEDURE BUDetail_ArrLoad_Expense
...
((ABS(PTDBal00) + ABS(PTDBal01) + ABS(PTDBal02) +  ABS(PTDBal03) + ABS(PTDBal04) + ABS(PTDBal05) +
 ...
 Account.AcctType IN ('1E', '2E', '3E', '4E')
