 Create Procedure [dbo].[PJBILL_Spk9] @parm1 varchar (24) , @parm2 varchar (10) , @parm3 varchar (2) , @parm4 varchar (16) , @parm5 smalldatetime, @parm6 varchar(6), @parm7 varchar(6), @parm8 varchar(10)  as
...
Order by
pjinvdet.project_billwith, pjinvdet.shipperid
