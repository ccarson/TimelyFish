...
--  Update: 03/06/15 (NJH)  replaced destination barn with packer description
-- 9/10/2015  ddahle  		 Added company check on driver name.
--*************************************************************

CREATE PROC [dbo].[pXT300MarketSchedule]
...
oh.Descr as PackerDesc,pm.DestBarnNbr,pm.DestRoomNbr, 								-- 03/06/15 NJH
...
LEFT JOIN cftPSOrdHdr oh on pm.OrdNbr = oh.OrdNbr															-- 03/06/15 NJH
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[pXT300MarketSchedule] TO [MSDSL]
    AS [dbo];
