 create procedure pjutlhrs_shvisub @parm1 varchar(1), @parm2 varchar (24) , @parm3 varchar (6) , @parm4 varchar (6) , @parm5 varchar(10)  as
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[pjutlhrs_shvisub] TO [MSDSL]
    AS [dbo];
