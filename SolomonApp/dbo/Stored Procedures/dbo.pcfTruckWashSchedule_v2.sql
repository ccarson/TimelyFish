...
CREATE  PROC [dbo].[pcfTruckWashSchedule_v2]
...
-- 2014-01-14  smr users wanted the pigtypeid and estimatedqty on the output
--*************************************************************
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[pcfTruckWashSchedule_v2] TO [MSDSL]
    AS [dbo];
