 /****** Object:  Stored Procedure dbo.BUDetail_ArrLoad_AsInEx    Script Date: 11/22/99 12:38:58 PM ******/
CREATE PROCEDURE BUDetail_ArrLoad_AsInEx
...
SELECT * FROM AcctHist, Account WHERE CpnyId = @parm1 AND FiscYr = @Parm2 and ledgerid = @parm3
 ...
 Account.AcctType IN ('1A', '2A', '3A', '4A','1I', '2I', '3I', '4I','1E', '2E', '3E', '4E')
