 /****** Object:  Stored Procedure dbo.InvtPrcCust_Price_GroupSite    Script Date: 1/12/08 12:30:33 PM ******/
CREATE PROCEDURE InvtPrcCust_Price_GroupSite
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[InvtPrcCust_Price_GroupSite] TO [MSDSL]
    AS [dbo];
