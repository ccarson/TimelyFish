...
Create Proc INTran_Invt_Site_Ref_Type @parm1 varchar ( 30) , @parm2 varchar ( 10) , @parm3 varchar ( 15) ,  @parm4 varchar ( 10)  as
Select * from INTran
	where InvtID = @parm1
	and Siteid = @parm2
	and Rlsed = 1
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[INTran_Invt_Site_Ref_Type] TO [MSDSL]
    AS [dbo];
