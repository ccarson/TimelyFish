CREATE PROCEDURE SyncQuickQueryViewRights_User
	@windowsAcct VARCHAR(85)
AS
...
WITH
	...
	WHERE so.type = 'V' AND dprin.name = @windowsAcct)
,
...
DECLARE @userAcct VARCHAR(85), @viewName VARCHAR(50), @action smallint
