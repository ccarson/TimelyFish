...
END
IF LEN(@parm4) > 0 AND @parm4 <> '%'	-- there is an Employee ID
BEGIN
	SELECT @szWhereEmpID = " AND e.EmployeeID = '" + @parm4 + "'"
END
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[smServFault_specEmpID] TO [MSDSL]
    AS [dbo];
