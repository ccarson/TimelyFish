 Create Procedure pjinvhdr_spk3p1 @parm1 varchar (10) , @parm2 varchar (10) , @parm3 varchar (24) , @parm4 varchar (10) , @parm5beg varchar (10) , @parm5end varchar (10) ,
  @parm6 char(100)
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[pjinvhdr_spk3p1] TO [MSDSL]
    AS [dbo];
