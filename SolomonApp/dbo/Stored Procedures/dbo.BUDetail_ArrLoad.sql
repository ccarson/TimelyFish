 /****** Object:  Stored Procedure dbo.BUDetail_ArrLoad    Script Date: 11/12/99 12:38:58 PM ******/
CREATE PROCEDURE BUDetail_ArrLoad
...
((ABS(PTDBal00) + ABS(PTDBal01) + ABS(PTDBal02) +  ABS(PTDBal03) + ABS(PTDBal04) + ABS(PTDBal05) +
 ...
 ABS(PTDBal12)) <> 0) AND AcctHist.Acct = Account.Acct
