...
--LEFT JOIN CentralData.dbo.SitePigFlow spf on
--	pm.SourceContactId=spf.ContactID
--	and spf.EffectiveDate=(Select Max(EffectiveDate) from CentralData.dbo.SitePigFlow
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[pPostArriveTestSiteList] TO [MSDSL]
    AS [dbo];
