 /****** Object:  Stored Procedure dbo.InvtCustPrice_Percent_GroupSite    Script Date: 1/12/08 12:30:33 PM ******/
CREATE PROCEDURE InvtCustPrice_Percent_GroupSite
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[InvtCustPrice_Percent_GroupSite] TO [MSDSL]
    AS [dbo];
