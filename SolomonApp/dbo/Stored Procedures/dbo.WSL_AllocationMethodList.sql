CREATE PROCEDURE WSL_AllocationMethodList
 @page  int
 ,@size  int
 ,@sort   nvarchar(200)
...
AS
  ...
  IF @page = 0  -- Don't do paging
	  BEGIN
		SET @STMT = 
			'SELECT Code_Value [Code Value], code_value_desc [Description], Data1 [Allocation Type], code_type [Code Type]
			 FROM PJCODE (nolock)
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[WSL_AllocationMethodList] TO [MSDSL]
    AS [dbo];
