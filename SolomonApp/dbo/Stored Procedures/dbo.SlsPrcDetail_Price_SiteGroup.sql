 /****** Object:  Stored Procedure dbo.SlsPrcDetail_Price_SiteGroup    Script Date: 1/12/08 12:30:33 PM ******/
CREATE PROCEDURE SlsPrcDetail_Price_SiteGroup
    ...
    @SlsUnits VarChar(6), @QtyBreak float, @CurrentPrice Float, @SiteGroupID VarChar (10), 
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[SlsPrcDetail_Price_SiteGroup] TO [MSDSL]
    AS [dbo];
