...
Create Proc SELECT_QtyOpenShip_Sum_SOSched @CpnyID varchar(10), @OrdNbr varchar(15), @LineRef varchar(5), @ShipToID VarChar(10), @ShipperID	varchar(15)

AS 
SELECT COUNT(*), SUM(s.QtyOpenShip)
