 create Procedure pjinvhdr_spk3p @parm1 varchar (10) , @parm2 varchar (10) , @parm3 varchar (24) , @parm4 varchar (10) , @parm5 varchar (100), @parm6 varchar(10) 
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[pjinvhdr_spk3p] TO [MSDSL]
    AS [dbo];
