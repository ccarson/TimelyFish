CREATE   Procedure pXF135_cftFeedOrder_CalcQty @parm1 varchar (10), @parm2 varchar (10), 
	...
	and o.OrdNbr <> @parm2 
	and o.DateOrd <= @parm3 
	and o.OrdType <> s.StatusCxl
	and o.RoomNbr = @parm4
	Group by o.StageOrd Order by o.StageOrd Desc

GO
GRANT CONTROL
    ON OBJECT::[dbo].[pXF135_cftFeedOrder_CalcQty] TO [MSDSL]
    AS [dbo];
