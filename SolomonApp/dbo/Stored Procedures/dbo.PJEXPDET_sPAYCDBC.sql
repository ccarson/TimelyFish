 create procedure PJEXPDET_sPAYCDBC  @parm1 varchar (4) , @parm2 smalldatetime , @parm3 smalldatetime , @parm4 varchar (10), @parm5 varchar(10), @parm6 varchar(100)
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[PJEXPDET_sPAYCDBC] TO [MSDSL]
    AS [dbo];
