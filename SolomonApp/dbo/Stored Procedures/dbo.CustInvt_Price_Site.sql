 /****** Object:  Stored Procedure dbo.CustInvt_Price_Site    Script Date: 1/12/08 12:30:33 PM ******/
CREATE PROCEDURE CustInvt_Price_Site
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[CustInvt_Price_Site] TO [MSDSL]
    AS [dbo];
