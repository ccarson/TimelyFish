 create procedure PJPROJ_scust2 @parm1 varchar (15) , @parm2 varchar (1) , @parm3 varchar(10), @parm4 varchar(100), @parm5 varchar(4) 
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[PJPROJ_scust2] TO [MSDSL]
    AS [dbo];
