 Create Procedure pjinvdet_stri3 @parm1 varchar (15) , @parm2 varchar (16) , @parm3 varchar (10) , @parm4 varchar (15) , @parm5 varchar (32) ,
@parm6 varchar (16) , @parm7 varchar (1) , @parm8 smalldatetime , @parm9 smalldatetime , @parm10 char(100)
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[pjinvdet_stri3] TO [MSDSL]
    AS [dbo];
