 Create Proc BOMTran_RefNbr_LineNbr_Inventory @parm1 varchar ( 15), @parm2beg smallint, @parm2end smallint as
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[BOMTran_RefNbr_LineNbr_Inventory] TO [MSDSL]
    AS [dbo];
