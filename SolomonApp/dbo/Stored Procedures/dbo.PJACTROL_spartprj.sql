 create procedure PJACTROL_spartprj @parm1 varchar (4) , @parm2 varchar (16) , @parm3 varchar (16), @parm4 varchar(100), @parm5 varchar(10) as
...
pjproj.project = pjactrol.project
) 
group by
fsyear_num
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[PJACTROL_spartprj] TO [MSDSL]
    AS [dbo];
