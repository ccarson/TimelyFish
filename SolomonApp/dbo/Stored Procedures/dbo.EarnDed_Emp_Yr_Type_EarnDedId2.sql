 Create Proc  EarnDed_Emp_Yr_Type_EarnDedId2 @parm1 varchar ( 10), @parm2 varchar ( 4), @parm3 varchar ( 1), @parm4 varchar ( 10) as
       Select *
		   from EarnDed
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[EarnDed_Emp_Yr_Type_EarnDedId2] TO [MSDSL]
    AS [dbo];
