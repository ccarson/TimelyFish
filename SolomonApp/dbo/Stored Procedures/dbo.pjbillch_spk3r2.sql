 Create Procedure pjbillch_spk3r2 @parm1 varchar (10) , @parm2 varchar (10) , @parm3 varchar (24) , @parm4beg varchar (16) , @parm4end varchar (16) , @parm5 varchar (6), @parm6 varchar (10),
  @parm7 varchar(100)
...
(select cpnyid from dbo.UserAccessCpny(@parm7))
