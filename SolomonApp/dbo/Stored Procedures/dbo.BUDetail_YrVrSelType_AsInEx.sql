 /****** Object:  Stored Procedure dbo.BUDetail_YrVrSelType_AsInEx    Script Date: 11/13/99 12:38:58 PM ******/
CREATE PROCEDURE BUDetail_YrVrSelType_AsInEx
...
AND Account.AcctType IN ('1A', '2A', '3A', '4A','1I', '2I', '3I', '4I','1E', '2E', '3E', '4E')
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[BUDetail_YrVrSelType_AsInEx] TO [MSDSL]
    AS [dbo];
