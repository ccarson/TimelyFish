 Create Procedure APDoc_APAdjust_Ref1 @parm1 varchar ( 15) As
Select
...
Order by APDocTmp.VendId, APDocTmp.DocClass, APDocTmp.Rlsed,
 APDocTmp.BatNbr, APDocTmp.RefNbr



GO
GRANT CONTROL
    ON OBJECT::[dbo].[APDoc_APAdjust_Ref1] TO [MSDSL]
    AS [dbo];
