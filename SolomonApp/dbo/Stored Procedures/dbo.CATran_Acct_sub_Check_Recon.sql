...
Create Proc CATran_Acct_sub_Check_Recon @parm1 varchar ( 10), @parm2 varchar ( 10), @parm3 varchar ( 24), @parm4 smalldatetime, @parm5 smalldatetime, @parm6 smalldatetime, @parm7 varchar(1), @parm8 smallint as
Select * from CATran
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[CATran_Acct_sub_Check_Recon] TO [MSDSL]
    AS [dbo];
