CREATE PROCEDURE WS_PJTran_INSERT
      ...
      @project char(16), @Subcontract char(16), @SubTask_Name char(50), @system_cd char(2), 
      ...
      @trans_date smalldatetime, @tr_comment char(100),
      ...
      @voucher_line int, @voucher_num char(10)
 AS
     BEGIN
      INSERT INTO [PJTran]
