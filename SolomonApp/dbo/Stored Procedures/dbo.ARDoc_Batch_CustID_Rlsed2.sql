 Create Procedure ARDoc_Batch_CustID_Rlsed2 @parm1 varchar ( 15), @parm2 varchar(47), @parm3 varchar(7), @parm4 varchar(1), @parm5 varchar (6)
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[ARDoc_Batch_CustID_Rlsed2] TO [MSDSL]
    AS [dbo];
