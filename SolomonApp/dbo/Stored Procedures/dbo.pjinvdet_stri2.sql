 Create Procedure pjinvdet_stri2 @parm1 varchar (15) , @parm2 varchar (16) , @parm3 varchar (10) , @parm4 varchar (15) , @parm5 varchar (32) ,
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[pjinvdet_stri2] TO [MSDSL]
    AS [dbo];
