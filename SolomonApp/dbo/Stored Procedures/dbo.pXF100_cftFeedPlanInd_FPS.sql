Create Procedure pXF100_cftFeedPlanInd_FPS @parm1 varchar (4), @parm2 varchar (10), @parm3 varchar (10), @parm4 smallint as 
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[pXF100_cftFeedPlanInd_FPS] TO [MSDSL]
    AS [dbo];
