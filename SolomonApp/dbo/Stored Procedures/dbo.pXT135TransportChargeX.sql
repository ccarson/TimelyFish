...
CREATE PROC dbo.pXT135TransportChargeX
		(@parm1 as varchar(10))
AS
...
Select pm.PMLoadID, tr.PMLoadID,tr.BatNbr as BatchNbr, tr.RefNbr as RefNbr,pm.MovementDate,
		...
		isnull(tw.StdLoadCharge,0),Multiplier=1,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[pXT135TransportChargeX] TO [SOLOMON]
    AS [dbo];


GO
GRANT CONTROL
    ON OBJECT::[dbo].[pXT135TransportChargeX] TO [MSDSL]
    AS [dbo];
