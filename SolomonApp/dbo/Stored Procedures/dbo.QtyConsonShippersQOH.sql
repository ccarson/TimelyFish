...
CREATE proc QtyConsonShippersQOH @InvtId varchar(30), @SiteId varchar (16), @WhseLoc varchar(10), 
                                     @ProjectId varchar (16), @TaskID varchar (32), @ShipperID varchar(15) AS
...
GO
GRANT CONTROL
    ON OBJECT::[dbo].[QtyConsonShippersQOH] TO [MSDSL]
    AS [dbo];
