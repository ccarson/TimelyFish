...
CREATE FUNCTION [dbo].[TaskNetProfitPerPeriod] 
(	
	@Per int
)
RETURNS TABLE 
...
(SELECT      PJPTDSUM.project AS Project, 
			...
			CASE WHEN isnumeric(PJACTSUM.amount_01) = 1 THEN 
				CASE @Per
                WHEN 0 THEN dbo.PJACTSUM.amount_bf 
				WHEN 1 THEN dbo.PJACTSUM.amount_01 
				WHEN 2 THEN dbo.PJACTSUM.amount_02 
				WHEN 3 THEN dbo.PJACTSUM.amount_03
                WHEN 4 THEN dbo.PJACTSUM.amount_04 
				WHEN 5 THEN dbo.PJACTSUM.amount_05 
				WHEN 6 THEN dbo.PJACTSUM.amount_06 
				WHEN 7 THEN dbo.PJACTSUM.amount_07
                WHEN 8 THEN dbo.PJACTSUM.amount_08 
				WHEN 9 THEN dbo.PJACTSUM.amount_09 
				WHEN 10 THEN dbo.PJACTSUM.amount_10 
				WHEN 11 THEN dbo.PJACTSUM.amount_11
                WHEN 12 THEN dbo.PJACTSUM.amount_12 
				WHEN 13 THEN dbo.PJACTSUM.amount_13 
				WHEN 14 THEN dbo.PJACTSUM.amount_14 
				WHEN 15 THEN dbo.PJACTSUM.amount_15
			...
			CASE WHEN isnumeric(PJACTSUM.amount_01) = 1 THEN
					CASE @Per 
                    WHEN 0 THEN dbo.PJACTSUM.amount_bf 
					WHEN 1 THEN dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 2 THEN dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 3 THEN dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 4 THEN dbo.PJACTSUM.amount_04 + dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 5 THEN dbo.PJACTSUM.amount_05 + dbo.PJACTSUM.amount_04 + dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + 
								dbo.PJACTSUM.amount_bf 
					WHEN 6 THEN dbo.PJACTSUM.amount_06 + dbo.PJACTSUM.amount_05 + dbo.PJACTSUM.amount_04 + dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + 
								dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 7 THEN dbo.PJACTSUM.amount_07 + dbo.PJACTSUM.amount_06 + dbo.PJACTSUM.amount_05 + dbo.PJACTSUM.amount_04 + dbo.PJACTSUM.amount_03 + 
								dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 8 THEN dbo.PJACTSUM.amount_08 + dbo.PJACTSUM.amount_07 + dbo.PJACTSUM.amount_06 + dbo.PJACTSUM.amount_05 + dbo.PJACTSUM.amount_04 + 
								dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 9 THEN dbo.PJACTSUM.amount_09 + dbo.PJACTSUM.amount_08 + dbo.PJACTSUM.amount_07 + dbo.PJACTSUM.amount_06 + dbo.PJACTSUM.amount_05 + 
								dbo.PJACTSUM.amount_04 + dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 10 THEN dbo.PJACTSUM.amount_10 + dbo.PJACTSUM.amount_09 + dbo.PJACTSUM.amount_08 + dbo.PJACTSUM.amount_07 + dbo.PJACTSUM.amount_06 + 
								 dbo.PJACTSUM.amount_05 + dbo.PJACTSUM.amount_04 + dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + 
								 dbo.PJACTSUM.amount_bf 
					WHEN 11 THEN dbo.PJACTSUM.amount_11 + dbo.PJACTSUM.amount_10 + dbo.PJACTSUM.amount_09 + dbo.PJACTSUM.amount_08 + dbo.PJACTSUM.amount_07 + 
								 dbo.PJACTSUM.amount_06 + dbo.PJACTSUM.amount_05 + dbo.PJACTSUM.amount_04 + dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + 
								 dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 12 THEN dbo.PJACTSUM.amount_12 + dbo.PJACTSUM.amount_11 + dbo.PJACTSUM.amount_10 + dbo.PJACTSUM.amount_09 + dbo.PJACTSUM.amount_08 + 
								 dbo.PJACTSUM.amount_07 + dbo.PJACTSUM.amount_06 + dbo.PJACTSUM.amount_05 + dbo.PJACTSUM.amount_04 + dbo.PJACTSUM.amount_03 + 
								 dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 13 THEN dbo.PJACTSUM.amount_13 + dbo.PJACTSUM.amount_12 + dbo.PJACTSUM.amount_11 + dbo.PJACTSUM.amount_10 + dbo.PJACTSUM.amount_09 + 
								 dbo.PJACTSUM.amount_08 + dbo.PJACTSUM.amount_07 + dbo.PJACTSUM.amount_06 + dbo.PJACTSUM.amount_05 + dbo.PJACTSUM.amount_04 + 
								 dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 14 THEN dbo.PJACTSUM.amount_14 + dbo.PJACTSUM.amount_13 + dbo.PJACTSUM.amount_12 + dbo.PJACTSUM.amount_11 + dbo.PJACTSUM.amount_10 + 
								 dbo.PJACTSUM.amount_09 + dbo.PJACTSUM.amount_08 + dbo.PJACTSUM.amount_07 + dbo.PJACTSUM.amount_06 + dbo.PJACTSUM.amount_05 + 
								 dbo.PJACTSUM.amount_04 + dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
					WHEN 15 THEN dbo.PJACTSUM.amount_15 + dbo.PJACTSUM.amount_14 + dbo.PJACTSUM.amount_13 + dbo.PJACTSUM.amount_12 + dbo.PJACTSUM.amount_11 + 
								 dbo.PJACTSUM.amount_10 + dbo.PJACTSUM.amount_09 + dbo.PJACTSUM.amount_08 + dbo.PJACTSUM.amount_07 + dbo.PJACTSUM.amount_06 + 
								 dbo.PJACTSUM.amount_05 + dbo.PJACTSUM.amount_04 + dbo.PJACTSUM.amount_03 + dbo.PJACTSUM.amount_02 + dbo.PJACTSUM.amount_01 + dbo.PJACTSUM.amount_bf 
			...
			com_amount AS CommitmentAmt, 
			com_units AS CommitmentUnit, 
			eac_amount AS EACAmt, eac_units AS EACUnit, 
			total_budget_amount AS OrigBudgetAmt, 
			total_budget_units AS OrigBudgetUnit, 
			total_budget_amount - eac_amount AS VarianceAmt, 
