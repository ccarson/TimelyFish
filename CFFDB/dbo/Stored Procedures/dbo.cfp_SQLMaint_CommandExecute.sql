...
CREATE PROCEDURE [dbo].[cfp_SQLMaint_CommandExecute]
...
--  SET @ErrorMessage = 'The table CommandLog is missing. Download https://ola.hallengren.com/scripts/CommandLog.sql.' + CHAR(13) + CHAR(10) + ' '
    SET @ErrorMessage = 'The table cft_SQLMaint_CommandLog is missing. Download https://ola.hallengren.com/scripts/CommandLog.sql.' + CHAR(13) + CHAR(10) + ' '
...
--  INSERT INTO dbo.CommandLog (DatabaseName, SchemaName, ObjectName, ObjectType, IndexName, IndexType, StatisticsName, PartitionNumber, ExtendedInfo, CommandType, Command, StartTime)
    INSERT INTO dbo.cft_SQLMaint_CommandLog (DatabaseName, SchemaName, ObjectName, ObjectType, IndexName, IndexType, StatisticsName, PartitionNumber, ExtendedInfo, CommandType, Command, StartTime)
...
--  UPDATE dbo.CommandLog
    UPDATE dbo.cft_SQLMaint_CommandLog
    SET EndTime = @EndTime,
