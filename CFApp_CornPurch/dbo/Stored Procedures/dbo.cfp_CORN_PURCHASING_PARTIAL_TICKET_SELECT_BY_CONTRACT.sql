...
-- Description:	Selects all PartialTicket records by contract
-- ===================================================================
CREATE PROCEDURE dbo.cfp_CORN_PURCHASING_PARTIAL_TICKET_SELECT_BY_CONTRACT
(
    @ContractID 	int
)
AS
...
INNER JOIN dbo.cft_CONTRACT C ON PT.ContractID = C.ContractID AND C.ContractID = @ContractID
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_PARTIAL_TICKET_SELECT_BY_CONTRACT] TO [db_sp_exec]
    AS [dbo];
