...
-- Description:	Selects GpaShrinkDeduction record by feed mill id
-- ===================================================================
CREATE PROCEDURE [dbo].[cfp_CORN_PURCHASING_GPA_SHRINK_DEDUCTION_SELECT_BY_FEED_MILL]
(
    @FeedMillID	char(10)
)
AS
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_GPA_SHRINK_DEDUCTION_SELECT_BY_FEED_MILL] TO [db_sp_exec]
    AS [dbo];
