...
-- Description:	Selects all GpaShrinkDeduction records
-- ===================================================================
CREATE PROCEDURE [dbo].[cfp_CORN_PURCHASING_GPA_SHRINK_DEDUCTION_SELECT]
AS
BEGIN
SET NOCOUNT ON;
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_GPA_SHRINK_DEDUCTION_SELECT] TO [db_sp_exec]
    AS [dbo];
