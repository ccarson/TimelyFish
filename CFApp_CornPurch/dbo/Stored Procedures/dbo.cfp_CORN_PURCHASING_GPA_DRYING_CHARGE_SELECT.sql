...
-- Description:	Selects all GpaDryingCharge records
-- ===================================================================
CREATE PROCEDURE [dbo].[cfp_CORN_PURCHASING_GPA_DRYING_CHARGE_SELECT]
AS
BEGIN
SET NOCOUNT ON;
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_GPA_DRYING_CHARGE_SELECT] TO [db_sp_exec]
    AS [dbo];
