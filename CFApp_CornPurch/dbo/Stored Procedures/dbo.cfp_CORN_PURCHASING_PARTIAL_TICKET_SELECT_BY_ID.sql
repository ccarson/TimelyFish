...
-- Description:	Selects PartialTicket record by id
-- ===================================================================
CREATE PROCEDURE dbo.cfp_CORN_PURCHASING_PARTIAL_TICKET_SELECT_BY_ID
(
    @PartialTicketID	int
)
AS
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_PARTIAL_TICKET_SELECT_BY_ID] TO [db_sp_exec]
    AS [dbo];
