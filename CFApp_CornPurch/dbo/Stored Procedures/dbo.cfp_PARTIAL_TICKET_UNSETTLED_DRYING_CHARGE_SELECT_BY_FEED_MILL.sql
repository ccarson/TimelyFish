...
-- ===================================================================
CREATE PROCEDURE dbo.cfp_PARTIAL_TICKET_UNSETTLED_DRYING_CHARGE_SELECT_BY_FEED_MILL
(
  @FeedMillID	char(10)
)
AS
...
AND CT.SentToDryer = 1

END

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_PARTIAL_TICKET_UNSETTLED_DRYING_CHARGE_SELECT_BY_FEED_MILL] TO [db_sp_exec]
    AS [dbo];
