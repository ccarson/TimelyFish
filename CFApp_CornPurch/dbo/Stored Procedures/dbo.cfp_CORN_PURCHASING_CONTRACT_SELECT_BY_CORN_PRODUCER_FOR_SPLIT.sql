...
===============================================================================
*/
CREATE PROCEDURE [dbo].[cfp_CORN_PURCHASING_CONTRACT_SELECT_BY_CORN_PRODUCER_FOR_SPLIT]
(
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_CONTRACT_SELECT_BY_CORN_PRODUCER_FOR_SPLIT] TO [db_sp_exec]
    AS [dbo];
