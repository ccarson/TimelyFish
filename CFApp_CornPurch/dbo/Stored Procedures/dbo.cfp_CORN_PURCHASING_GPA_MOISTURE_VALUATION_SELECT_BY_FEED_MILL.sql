...
-- Description:	Selects GpaMoistureValuation record by feed mill id
-- ===================================================================
CREATE PROCEDURE [dbo].[cfp_CORN_PURCHASING_GPA_MOISTURE_VALUATION_SELECT_BY_FEED_MILL]
(
    @FeedMillID	char(10)
)
AS
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_GPA_MOISTURE_VALUATION_SELECT_BY_FEED_MILL] TO [db_sp_exec]
    AS [dbo];
