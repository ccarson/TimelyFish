...
-- Description:	Returns corn producer by id
-- =============================================
CREATE PROCEDURE [dbo].[cfp_CORN_PRODUCER_SELECT_BY_ID]
(
...
WHERE CornProducer.CornProducerID = @CornProducerID
END


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PRODUCER_SELECT_BY_ID] TO [db_sp_exec]
    AS [dbo];
