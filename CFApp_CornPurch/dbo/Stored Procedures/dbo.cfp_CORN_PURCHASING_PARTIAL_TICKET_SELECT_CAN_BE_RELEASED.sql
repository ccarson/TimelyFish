...
-- ===================================================================
CREATE PROCEDURE dbo.cfp_CORN_PURCHASING_PARTIAL_TICKET_SELECT_CAN_BE_RELEASED
(
  @FeedMillID char(10)
)
AS
...
WHERE FT.FeedMillID = @FeedMillID AND NOT(	PT.PaymentTypeID IN (3,4) 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_PARTIAL_TICKET_SELECT_CAN_BE_RELEASED] TO [db_sp_exec]
    AS [dbo];
