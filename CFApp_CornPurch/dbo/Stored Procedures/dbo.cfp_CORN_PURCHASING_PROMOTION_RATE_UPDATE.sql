...
-- ===================================================================
CREATE PROCEDURE [dbo].[cfp_CORN_PURCHASING_PROMOTION_RATE_UPDATE]
(
    @PromotionID	int,
...
BEGIN
  ...
  UPDATE dbo.cft_PROMOTION_RATE SET
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_PROMOTION_RATE_UPDATE] TO [db_sp_exec]
    AS [dbo];
