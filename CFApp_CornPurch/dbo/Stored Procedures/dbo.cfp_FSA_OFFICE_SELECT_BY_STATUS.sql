...
-- Description:	Returns all FSA Offices by status (active or inactive)
-- ====================================================================
CREATE PROCEDURE [dbo].[cfp_FSA_OFFICE_SELECT_BY_STATUS]
(
	@Active		bit
)
AS
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_FSA_OFFICE_SELECT_BY_STATUS] TO [db_sp_exec]
    AS [dbo];
