...
-- Description:	Selects GpaDeferredPayment record by id
-- ===================================================================
CREATE PROCEDURE [dbo].[cfp_CORN_PURCHASING_GPA_DEFERRED_PAYMENT_SELECT_BY_ID]
(
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cfp_CORN_PURCHASING_GPA_DEFERRED_PAYMENT_SELECT_BY_ID] TO [db_sp_exec]
    AS [dbo];
