...
-- ===================================================================
CREATE FUNCTION [dbo].[cffn_CORN_PURCHASING_GPA_DRYING_CHARGE_ID_BY_DATE_AND_RANGE]
(
...
SELECT @GPADryingChargeID = DCD.[GPADryingChargeID]
FROM dbo.cft_GPA_DRYING_CHARGE_DETAIL DCD
INNER JOIN dbo.cft_GPA_DRYING_CHARGE DC ON DC.GPADryingChargeID = DCD.GPADryingChargeID
WHERE DC.Active = 1 
      AND DC.[Default] = 0 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cffn_CORN_PURCHASING_GPA_DRYING_CHARGE_ID_BY_DATE_AND_RANGE] TO [ApplicationCenter]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[cffn_CORN_PURCHASING_GPA_DRYING_CHARGE_ID_BY_DATE_AND_RANGE] TO [db_sp_exec]
    AS [dbo];
